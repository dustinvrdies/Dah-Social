...
import { LogIn, Search, Coins, Menu } from "lucide-react";
      ...
      <header className="sticky top-0 z-50 bg-card/95 backdrop-blur-xl border-b border-border/50">
        <div className="flex items-center justify-between gap-3 h-14 px-4 max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            ...
            {session && (
              <Link href="/dashboard">
                <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-gradient-to-r from-primary/10 to-secondary/10 border border-primary/20 cursor-pointer hover-elevate" data-testid="display-coin-balance">
